...
class HomeAdapter(private var projectList: List<AuditionList>, private var context: Context) : RecyclerView.Adapter<HomeAdapter.CardViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): CardViewHolder {
        val inflater = context.getSystemService(Context.LAYOUT_INFLATER_SERVICE) as LayoutInflater
        val v = inflater.inflate(R.layout.custom_home, parent, false)
