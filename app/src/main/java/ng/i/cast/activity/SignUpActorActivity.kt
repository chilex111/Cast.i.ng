...
class SignUpActorActivity : AppCompatActivity() {
    ...
    private var editPromo : EditText ?= null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_sign_up_actor)
    ...
    private fun submitForm() {
        ...
        val promoText = editPromo!!.text.toString()
        ...
        when{
            ...
            addressText.isEmpty()->
                editAddress!!.error = "This field is required"
            emailText.isEmpty()->
                editEmail!!.error = "This field is required"
            else ->
                if (appUtils!!.hasActiveInternetConnection())
                    SignUpAsync(emailText,passwordText,fNameText,lNameText,addressText,phoneText,promoText,companyText).execute()
                else
    ...
    inner class SignUpAsync(private var emailText: String, private var passwordText: String,private var fNameText: String,
                            private var lNameText: String, private var addressText: String,private var phoneText: String,
                            private var promoText: String,private var companyText: String) : AsyncTask<Void, Int, String>(){
        ...
        override fun onPostExecute(result: String?) {
            ...
            if (!result.isNullOrEmpty()){
                ...
                try{
                    ...
                    if (userModel != null){
                        if (userModel.status!!){
                            val localBuilder = AlertDialog.Builder(this@SignUpActorActivity)
                            localBuilder.setMessage(userModel.statusMsg)
                            localBuilder.setNeutralButton(R.string.ok) { _, _ ->
                                startActivity(Intent(this@SignUpActorActivity, LoginActivity::class.java))}
